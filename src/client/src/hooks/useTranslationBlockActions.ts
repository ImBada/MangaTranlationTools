...
export function useTranslationBlockActions({
  ...
  const createEmptyBlock = React.useCallback(() => {
    ...
    const block: TranslationBlock = {
      ...
      shadowOpacityLinkedToPreset: editingFontPreset ? true : undefined,
      shadowBlurPxLinkedToPreset: editingFontPreset ? true : undefined,
      ...
      shadowOpacity: sourcePreset.shadowOpacity,
      shadowBlurPx: sourcePreset.shadowBlurPx,
